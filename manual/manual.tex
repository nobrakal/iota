...
Contrary to approaches like LittleB \cite{littleb} which is plain LISP, the smallness of \Iota{} is its strength: it is very simple to analyse it and compiling it to the languages.
